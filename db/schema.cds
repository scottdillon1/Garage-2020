...
using {managed,
      sap.common } from '@sap/cds/common';
...
Entity SafetyIncidents : managed {
  ...
  incidentPhotos         : Association to many IncidentPhotos on incidentPhotos.safetyIncidentId;
}
...
entity IncidentPhotos : managed {
  ...
  safetyIncidentId : Association to SafetyIncidents;
}
